*log using "C:\Users\klenow\Documents\Rawls\USA\growth_06_log.smcl", replace
*log using "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\USA\growth_06_log.smcl", replace

*****************************************************************************
*		 FIND THE GROWTH LAMBDA IN THE U.S. BETWEEN 1984 - 2006				*
* This program computes the % reduction in consumption that individuals are *
* willing to undertake in 2006 and still be as well of as they were in 1984 *
*****************************************************************************

*** The program proceeds in 3 steps

*** STEP I: Calculate base (2006) values for CbarUSA, LbarUSA, CineqUSA, 
* LineqUSA etc using 2006 data and 2006 survival rates

*** STEP II, use 1984 data with 2006 survival rates and combine with Part I 
* and II to get growth lambda's. NOTE: Because the Indian data for consumption and 
* leisure have different weights, this 2nd step is itself done in 2 sub-steps
...
* 	2006 dollars to constant international prices, incorporate govt consumption
...
*merge m:1 country_code year age using "C:\Users\klenow\Documents\Rawls\Survival Rates\survivalUSA06.dta"
merge m:1 country_code year age using "$survival_ind/survivalUSA06.dta"
keep if year==2006
keep if country_code=="USA"
drop _merge
...
*generate log_cbar and log_lbar, the log of average ca and la, with s_USAa as weights
* 
...
scalar Cbar_USA_06=exp(log_cbar_06) //This is 2006 micro data on consumption weighted by 2006 survival rates
scalar epsLbar_USA_06=eps_lbar_06 //This is 2006 micro data on leisure weighted by 2006 survival rates
scalar Cineq_USA_06=Elogc_06-log_cbar_06
scalar Lineq_USA_06=-$theta*(Eeps_l_06-eps_lbar)
...
****** Lambda's are found in 2 steps because 1983 Indian consumption and expenditure data are different ******
...
*Now that we have allocated expenditures to individuals, convert individual consumption from 
* 	1984 dollars to constant international prices, incorporate govt consumption
* 	using Penn World Tables 6.3, and scale to year $baseyear US $
...
*Merge with country-age level surivival rate variables 
sort country_code year age 
*merge m:1 country_code year age using "C:\Documents and Settings\Sid\My Documents\phd\pete\Rawls\stata_copy\stata\growth\survivalUSA.dta"
*merge m:1 country_code year age using "C:\Users\klenow\Documents\Rawls\Survival Rates\survivalUSA06.dta"
merge m:1 country_code year age using "$survival_ind/survivalUSA06.dta"
keep if year==1990
keep if country_code=="USA"
...
*list age s_USAa logca logla ca utila
...
scalar log_lambda_C_avg = log_cbar - ln(Cbar_USA_06)


* Calculate consumption inequality term
scalar log_lambda_C_ineq = Elogc - log_cbar - Cineq_USA_06
...
**open 1984 leisure data file.
quietly {
*use "C:\Documents and Settings\Sid\My Documents\phd\pete\Rawls\stata_copy\stata\38\Rawls\final\USA_84.dta",clear
*use "C:\Users\klenow\Documents\Rawls\USA\USA_84.dta", clear
use "USA_84.dta", clear
drop if age <= 0
drop if age > 100
...
*list age s_USAa logca logla ca la utila
...
scalar log_lambda_L_avg = -$theta*(eps_lbar - epsLbar_USA_06)

* Calculate leisure inequality term
scalar log_lambda_L_ineq = -$theta*(Eeps_l-eps_lbar) - Lineq_USA_06
