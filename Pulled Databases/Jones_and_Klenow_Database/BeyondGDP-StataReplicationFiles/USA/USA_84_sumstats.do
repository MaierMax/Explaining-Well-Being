...
gen hhexp = nondurnd + veisernd + veiothnd + housesernd + rentrnd + othlodnd + enternd
keep if hhexp~=.
...
save "C:\Users\Pete\Dropbox\Beyond_GDP\USA\Sumstats\USA_84", replace

describe
summarize
*list

outsheet hhid pcode age hhexp leisure weight using USA_84.csv , comma replace
