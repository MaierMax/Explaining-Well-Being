...
*use "C:\Users\Pete\Dropbox\Beyond_GDP\USA\fabrizio_cex.dta", clear
use "C:\Users\Klenow\Dropbox\Beyond_GDP\USA\fabrizio_cex.dta", clear
*use "C:\Users\klenow.ECON\Dropbox\Beyond_GDP\USA\Sumstats\fabrizio_cex.dta", clear
...
drop if hhexp < 0
*replace leisure=-999 if leisure==1 & age<25

keep age hhid pcode hhexp hhinc leisure hhsize weight
*save "C:\Users\klenow\Documents\Rawls\USA\USA_06", replace
*save "C:\Users\Pete\Dropbox\Beyond_GDP\USA\Sumstats\USA_06", replace
save "C:\Users\Klenpow\Dropbox\Beyond_GDP\USA\Sumstats\USA_06", replace
*save "C:\Users\klenow.ECON\Dropbox\Beyond_GDP\USA\Sumstats\USA_06", replace

describe
summarize
*list

outsheet hhid pcode age hhexp leisure weight using USA_06.csv , comma replace

	format weight %11.4e
	outfile  using "USA_06.txt", wide replace
