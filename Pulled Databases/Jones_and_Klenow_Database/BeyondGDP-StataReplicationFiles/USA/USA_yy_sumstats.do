...
*use "C:\Users\Rui\Dropbox\Beyond_GDP\USA\Sumstats\fabrizio_cex.dta", clear
*cd "C:\Users\Pete\Dropbox\Beyond_GDP\USA\Sumstats"
*cd "C:\Users\klenow.ECON\Dropbox\Beyond_GDP\USA"
*cd /Users/xurui/Dropbox/Beyond_GDP/USA
*use "Sumstats/fabrizio_cex.dta", clear
cd "C:\Users\klenow\Dropbox\Beyond_GDP\USA"
use "Sumstats\fabrizio_cex.dta", clear
*1993 1997 2000 2001 2002 2003 2004 2005 2006 2007
...
gen year = intyea + 1900
	...
	gen hhexp = nondurn + veisernd + veiothnd + housesernd + rentrnd + othlodnd + enternd
	keep if hhexp~=.
...
* Rename and generate variables for individuals to prepare for reshape
	...
	bysort hhid: gen hhsize_rui=_N
	gen diff = hhsize - hhsize_rui
	tab diff
	...
	*normalize weights to sum to 1
	...
	drop if hhexp < 0
*	leisure = -999 if (leisure=1 and age < 25)
	
	keep hhid hhsize age hhexp leisure weight
	order hhid hhsize age hhexp leisure weight
	*save "C:\Users\klenow\Documents\Rawls\USA\USA_84", replace
	save "USA_`yy'", replace

	describe
	summarize
	*list
	format weight %11.4e
	outfile  using "USA_`yy'.txt ", wide replace
exit
