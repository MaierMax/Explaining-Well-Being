...
set varabbrev off
*cap log close
*log using CHIP_2002_lamstats_CV.log, replace
...
* 	2002 Chinan rand to constant international prices, incorporate govt consumption
...
*Check that the weighted average of chad is 0.2187
...
*  Columns: age, U.S. survival rate, Chinese survival rate, log consumption, 
...
sort year age 
merge m:1 year age using "$working_dir/USA/USA_02_byage.dta" 
*merge m:1 year age using "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\USA\USA_02_byage.dta"
drop _merge
