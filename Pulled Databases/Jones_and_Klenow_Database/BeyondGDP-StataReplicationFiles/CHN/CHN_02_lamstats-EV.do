...
*cd "C:\Users\DD_RR\Dropbox\Projects_Pete\CHIP Data sets\CHN"
*log using CHN_2002_lamstats_EV.log, replace
...
* U.S. 2002 C relative to U.S. $baseyear C
...
* U.S. 2002 average consumption (demographic adjustment)
keep if year ==2002
...
quietly {
*use 02"C:\Users\klenow\Documents\Rawls\CHN\CHN_02.dta", clear
use "CHN_02.dta", clear
ren hhexp exp
}
...
* 	2002 South African rand to constant international prices, incorporate govt consumption
...
*Bring in cpop and gpop by merging CHN_02.dta with PWT_cpop_gpop.dta
sort country_code year
...
*Check that the weighted average of chat is 0.2187
...
*  Columns: age, U.S. survival rate, South African survival rate, log consumption, 
...
*Convert variables for missing ages from zero to missing (Note: 97 and 98 for CHN) 
...
* Lambda Decomposition for CHN 2002 vs. USA 2002
