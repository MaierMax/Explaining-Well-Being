...
* U.S. 2007 C relative to U.S. $baseyear C
...
* U.S. 2007 average consumption (demographic adjustment)
...
*use "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\ITA\ZAF_93.dta", clear
ren hhexp exp
}
...
* 	2007 South African rand to constant international prices, incorporate govt consumption
...
*Bring in cpop and gpop by merging ZAF_93.dta with PWT_cpop_gpop.dta
sort country_code year
...
*Convert variables for missing ages from zero to missing (Note: 97 and 98 for RUS) 
...
sort year age 
merge m:1 year age using "$working_dir/USA/USA_07_byage.dta" 
...
* Lambda Decomposition for RUS 2007 vs. USA 2007
