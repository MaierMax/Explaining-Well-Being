*log using "C:\Users\klenow.ECON\Documents\Rawls\RUS\RUS_98_growth.smcl", replace
*log using "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\RUS\RUS_98_growth.smcl", replace


*****************************************************************************
*		 FIND THE GROWTH IN LAMBDA IN RUS BETWEEN 1998 - 2007				*
* This program computes the % increase in consumption that individuals 	    *
* need in 1998 to be as well of as they are in 2007 					    *
*****************************************************************************

*** STEP I: Calculate base (1998) values for CbarRUS, LbarRUS, CineqRUS, 
* LineqRUS etc using 1998 data and 1998 survival rates. 

*** STEP II, use 2007 data with 1998 survival rates and combine with Part I 
* and II to get growth lambda's. 


**********************************************************
*********				STEP I  			 *************
********* 1998 data with 1998 survival rates *************
**********************************************************
...
set more off
set varabbrev off
*cd "C:\Zach\Projects_Pete\Beyond GDP\RUS"
...
*use "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\RUS\RUS_98.dta", clear
...
* 	1998 French francs to constant international prices, incorporate govt consumption
...
merge m:1 country_code year age using "$survival_ind/survivalRUS98.dta"
*merge m:1 country_code year age using "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\Survival Rates\survivalRUS98.dta"
keep if year==1998
keep if country_code=="RUS"
drop _merge
...
scalar log_cbar_98=log_cbar
scalar Elogc_98=Elogc

scalar Cbar_RUS_98=exp(log_cbar_98)
scalar Cineq_RUS_98=Elogc_98-log_cbar_98
...
*generate log_lbar, the log of average la, with s_RUSa as weights
* 
...
scalar eps_lbar_98=eps_lbar
scalar Eeps_l_98=Eeps_l

scalar epsLbar_RUS_98=eps_lbar_98 
scalar Lineq_RUS_98=-$theta*(Eeps_l_98-eps_lbar)
...
**open 2007 consumption data file. Discard age > 100 and renormalize weights
quietly {
use "RUS_07.dta", clear
*use "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\RUS\RUS_07.dta", clear
...
*Now that we have allocated expenditures to individuals, convert individual consumption from 
* 	2007 French francs to constant international prices, incorporate govt consumption
* 	using Penn World Tables 6.3, and scale to year $baseyear US $
...
collapse (mean) logca=logca logla=logla eps_la la=la ca=ca s_RUSa=s_RUSa  delta_s_RUSa= delta_s_RUSa, by(country_code year age)
...
scalar log_lambda_C_avg = log_cbar - ln(Cbar_RUS_98)

* Calculate average leisure term
scalar log_lambda_L_avg = -$theta*(eps_lbar - epsLbar_RUS_98)

* Calculate consumption inequality term
scalar log_lambda_C_ineq = Elogc - log_cbar - Cineq_RUS_98

* Calculate leisure inequality term
scalar log_lambda_L_ineq = -$theta*(Eeps_l-eps_lbar) - Lineq_RUS_98
