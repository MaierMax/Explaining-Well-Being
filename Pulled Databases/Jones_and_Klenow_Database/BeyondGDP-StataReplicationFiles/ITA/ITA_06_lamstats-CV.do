...
*log using ZAF_93_lamstats_CV.log, replace
...
* U.S. 2006 C relative to U.S. $baseyear C
...
* 	2006 South African rand to constant international prices, incorporate govt consumption
...
*Convert variables for missing ages from zero to missing (Note: 97 and 98 for ITA) 
...
sort year age 
merge m:1 year age using "$working_dir/USA/USA_06_byage.dta" 
...
* Lambda Decomposition for ITA 2006 vs. USA 2006
