*log using "C:\Users\klenow.ECON\Documents\Rawls\ITA\ITA_87_growth.smcl", replace
*log using "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\ITA\ITA_87_growth.smcl", replace


*****************************************************************************
*		 FIND THE GROWTH IN LAMBDA IN ITA BETWEEN 1987 - 2006				*
* This program computes the % increase in consumption that individuals 	    *
* need in 1987 to be as well of as they are in 2006 					    *
*****************************************************************************

*** STEP I: Calculate base (1987) values for CbarITA, LbarITA, CineqITA, 
* LineqITA etc using 1987 data and 1990 survival rates. 
...
**********************************************************
*********				STEP I  			 *************
********* 1987 data with 1990 survival rates *************
**********************************************************
...
*use "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\ITA\ITA_87.dta", clear
...
* 	1987 French ITAncs to constant international prices, incorporate govt consumption
...
merge m:1 country_code year age using "$survival_ind/survivalITA90.dta"
*merge m:1 country_code year age using "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\Survival Rates\survivalITA90.dta"
keep if year==1990
keep if country_code=="ITA"
drop _merge
...
scalar log_cbar_87=log_cbar
scalar Elogc_87=Elogc

scalar Cbar_ITA_87=exp(log_cbar_87)
scalar Cineq_ITA_87=Elogc_87-log_cbar_87
...
*generate log_lbar, the log of average la, with s_ITAa as weights
* 
...
scalar eps_lbar_87=eps_lbar
scalar Eeps_l_87=Eeps_l

scalar epsLbar_ITA_87=eps_lbar_87 
scalar Lineq_ITA_87=-$theta*(Eeps_l_87-eps_lbar)
...
**open 2006 consumption data file. Discard age > 100 and renormalize weights
quietly {
use "ITA_06.dta", clear
*use "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\ITA\ITA_06.dta", clear
...
*Now that we have allocated expenditures to individuals, convert individual consumption from 
* 	2006 French ITAncs to constant international prices, incorporate govt consumption
* 	using Penn World Tables 6.3, and scale to year $baseyear US $
...
collapse (mean) logca=logca logla=logla eps_la la=la ca=ca s_ITAa=s_ITAa  delta_s_ITAa= delta_s_ITAa, by(country_code year age)
...
scalar log_lambda_C_avg = log_cbar - ln(Cbar_ITA_87)

* Calculate average leisure term
scalar log_lambda_L_avg = -$theta*(eps_lbar - epsLbar_ITA_87)

* Calculate consumption inequality term
scalar log_lambda_C_ineq = Elogc - log_cbar - Cineq_ITA_87

* Calculate leisure inequality term
scalar log_lambda_L_ineq = -$theta*(Eeps_l-eps_lbar) - Lineq_ITA_87
