...
*** STEP I: Calculate base (2008) values for CbarBRA, LbarBRA, CineqBRA, 
* LineqBRA etc using 2008 data and 2008 survival rates. NOTE: Because 2008
* data for consumption and leisure have different weights, this 2nd step is
* itself done in 2 sub-steps

*** STEP II, use 2003 data with 2008  survival rates and combine with Part I 
...
**********************************************************
*********				STEP I  			 *************
********* 2008 data with 2008 survival rates *************
**********************************************************
...
merge m:1 country_code year age using "$survival_ind/survivalBRA08.dta"
keep if year==2008
keep if country_code=="BRA"
drop _merge
