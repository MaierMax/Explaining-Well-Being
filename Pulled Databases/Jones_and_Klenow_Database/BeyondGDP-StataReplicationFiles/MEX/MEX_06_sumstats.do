...
*local pete_raw_data_root
*cd "C:\Users\Rui\Dropbox\Beyond_GDP"
*local pete_raw_data_root "C:\Users\Rui\Dropbox\Beyond_GDP/MEX"
cd "/Users/xurui/Dropbox/Beyond_GDP"
local pete_raw_data_root "/Users/xurui/Dropbox/Beyond_GDP/MEX"
...
*}
sort hhid
merge 1:m hhid using "MEX/MEX_`yy'.dta"
...
merge 1:1 hhid pcode using "MEX/MEX_`yy'.dta"
drop _merge
}
drop if hours_wo<0 
...
format weight %11.4e
*list
outfile using MEX/MEX_`yy'.txt , wide noquote replace
