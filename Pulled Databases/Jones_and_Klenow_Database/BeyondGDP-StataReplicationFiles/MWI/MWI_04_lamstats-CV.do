* MWI 2004 March - 2005 March (2004 figures from PWT are being used)
...
*og using MWI_04_lamstats_CV.log, replace
...
* U.S. 2004 C relative to U.S. $baseyear C
...
* U.S. 2004 average consumption (demographic adjustment)
...
ren weight weight_temp     /* weight is household weight from data */
...
*exp is annual nondurable expenditure in Malawi 2004 local currency 
*adjusting for regional differences in price levels
foreach var in exp {
if rule==1 {
...
* 	2004 Indian Rupee to constant international prices, incorporate govt consumption
...
sort year age 
merge m:1 year age using "$working_dir/USA/USA_04_byage.dta" 
...
* Lambda Decomposition for IND 2004
...
*mat result =[sd_lnchat_unwt, sd_lnchat_wt,sd_lnchat_w,sd_rholeisure_w,log_cbar,log_lambda_LE,log_lambda_C_avg,log_lambda_L_avg,log_lambda_C_ineq,log_lambda_L_ineq,log_lambda]
mat result =[log_lambda,log_lambda_LE,log_lambda_C_avg,log_lambda_L_avg,log_lambda_C_ineq,log_lambda_L_ineq]

svmat result
outsheet using "C:\Users\Huiyu\Documents\peterawls\MWI_04_CV_result.csv", comma replace
