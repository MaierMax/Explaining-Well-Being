...
*log using MWI_04_lamstats_EV.log, replace
...
* pcode = 1 if head of the household
quietly{
...
* 	2004 Malawi Kawachi to constant international prices, incorporate govt consumption
...
drop c_hat_jit wc cpop gpop cgpop_US_$baseyear _merge 
...
*merge m:1 country_code year age using "C:\Users\klenow\Documents\Rawls\Survival Rates\survival.dta" 
...
*********************************
su eps_leisure [weight=s_USa*wbar]
return list
...
*generate log_cbar and log_lbar, the log of average ca and la, with s_USa as weights
...
* Calculate leisure inequality term - NEED TO CHANGE LINEQUS
...
*svmat result
*outsheet using "C:\Users\Huiyu\Documents\peterawls\MWI_04_EV_result.csv", comma replace
