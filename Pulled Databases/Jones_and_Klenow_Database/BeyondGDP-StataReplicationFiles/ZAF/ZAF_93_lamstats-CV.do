...
* U.S. 1993 C relative to U.S. $baseyear C
...
* U.S. 1993 average consumption (demographic adjustment)
...
quietly {
use "ZAF_93.dta", clear
*use "C:\Documents and Settings\Pete Klenow\My Documents\My Documents\Rawls\ZAF\ZAF_93.dta", clear
ren hhexp exp
}
...
* 	1993 South African rand to constant international prices, incorporate govt consumption
...
*interpolate logca, logla, ca, la for missing ages (Note: 97 and 98 for ZAF)
...
sort year age 
merge m:1 year age using "$working_dir/USA/USA_93_byage.dta" 
...
* Lambda Decomposition for ZAF 1993 vs. USA 1993
