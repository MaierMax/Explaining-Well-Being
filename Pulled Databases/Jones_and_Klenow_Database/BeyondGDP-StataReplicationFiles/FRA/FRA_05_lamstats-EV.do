...
*log using "C:\Users\klenow.ECON\Documents\Rawls\FRA\FRA_05_lamstats.log", replace
...
* U.S. $baseyear C relative to U.S. $baseyear C
*  Bring in cpop and gpop from PWT_cpop_gpop.dta.

*******************************************************************CHANGE DIRECTORY HERE********************
*cd "C:\Users\klenow.ECON\Documents\Rawls\FRA"
*cd "/Users/xurui/Dropbox/Beyond_GDP/FRA"
************************************************************************************************************

use "$pwt_file"
*use PWT_cpop_gpop.dta
...
* U.S. 2005 demographic adjustment to average C
...
*Bring in cpop and gpop by merging FRA_05.dta with PWT_cpop_gpop.dta
sort country_code year
...
*Check that the weighted average of chat is 0.2598602
...
***********FRANCE survival does not have 2005**************;

*merge country_code year age using survival.dta 
merge m:1 country_code year age using  "$survival_file" 
*merge m:1 country_code year age using "E:\4th Year\KLENOW_RA\survival.dta"  
