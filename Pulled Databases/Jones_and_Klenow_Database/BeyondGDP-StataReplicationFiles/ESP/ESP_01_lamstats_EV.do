...
scalar drop _all
drop _all
*C:\Users\klenow\Documents\Rawls\ESP\
...
*use "C:\Users\klenow.ECON\Documents\Rawls\PWT 6.3\PWT_cpop_gpop.dta"
use "$pwt_file", clear
...
*merge m:m country_code year using "C:\Users\klenow.ECON\Documents\Rawls\PWT 6.3\PWT_cpop_gpop.dta"
...
*merge m:1 country_code year age using "C:\Users\klenow.ECON\Documents\Rawls\Survival Rates\survival.dta" 
merge m:1 country_code year age using "$survival_file"
keep if year==2001
keep if country_code=="ESP"
drop _merge

**Compute stdev of ln(chat) ln(inc) with U.S. demographic weights
...
*create ca, which is sum of chat*wbar within age groups.
...
save "ESP_01_lamstats_EV_cons.dta", replace
...
**Compute stdev of ln(leisure) with U.S. demographic weights
qui {
su lnleisure [weight=s_USa*wbar]
return list
...
collapse (mean) logla=logla eps_la=eps_la la=la s_USa=s_USa delta_s_ia=delta_s_ia, by(country_code year age)
...
merge 1:1 country_code year age using "ESP_01_lamstats_EV_cons.dta"
drop _merge
